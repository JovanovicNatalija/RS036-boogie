...
public:
    ...
    Q_INVOKABLE void connectToServer(const QString& username,const QString& ip, quint16 port = 10000);
    ...
    Q_INVOKABLE void addMsgToBuffer(const QString& sender,const QString& inConversationWith,const QString& msg);
